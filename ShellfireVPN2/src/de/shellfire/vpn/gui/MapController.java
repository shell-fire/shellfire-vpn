...
class MapController {
    ...
    public MapController(JXMapKit jXMapKit1, Controller controller) {
        ...
        this.mapKit.setAddressLocation(new GeoPosition(51.16762, 10.45905));
        this.initPainter();
    ...
    void setServers(ServerList serverList) {
    ...
    void setShowOwnPositionOnMap(boolean showOwnPositionOnMap) {
