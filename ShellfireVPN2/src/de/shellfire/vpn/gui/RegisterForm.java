...
public class RegisterForm extends javax.swing.JFrame {
    ...
    class RequestNewAccountTask extends SwingWorker<Void, Void> {
        ...
        protected Void doInBackground() throws Exception {
            WsRegistrationResult registrationResult = service.registerNewFreeAccount(jEmailAddress.getText(), jPassword.getText(), jNewsletterCheckbox.isSelected(), isResend);
            
            if (registrationResult.isRegistrationOk()) {
            	activationToken = registrationResult.getToken();            	
            } else {
                if (progressDialog != null) {
                    progressDialog.setVisible(false);
                }

                JOptionPane.showMessageDialog(null, i18n.tr("Fehler bei Registrierung:") + " " + i18n.tr(registrationResult.getErrorMessage()), i18n.tr("Fehler"), JOptionPane.ERROR_MESSAGE);
    ...
    class AccountActiveServicePollerTask extends SwingWorker<Void, Void> {
        ...
        @Override
        protected Void doInBackground() throws Exception {
            while (cont && !(accountActive = service.accountActive(activationToken))) {
                Thread.sleep(3000);
            }
