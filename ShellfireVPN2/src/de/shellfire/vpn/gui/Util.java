...
public class Util {
  ...
  public static boolean isWin8OrWin10() {
	...
	public static List<String> getPossibleExeLocations(String programFiles, String programFiles86) {
		if (isWindows()) {
			return Arrays.asList("openvpn\\openvpn.exe", "..\\openvpn\\openvpn.exe", programFiles + "\\ShellfireVPN\\openvpn\\openvpn.exe", programFiles86
					+ "\\ShellfireVPN\\openvpn\\openvpn.exe", programFiles + "\\OpenVPN\\openvpn.exe", programFiles86 + "\\OpenVPN\\openvpn.exe", programFiles
					+ "\\ShellfireVPN\\bin\\openvpn.exe", programFiles86 + "\\ShellfireVPN\\bin\\openvpn.exe");
		} else {
