...
import de.shellfire.vpn.ProductType;
...
public class VpnSelectDialog extends javax.swing.JFrame {
  private static final long serialVersionUID = 1L;
    ...
    private void initComponents() {
        ...
        jBackLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/shellfire/vpn/gui/resources/exit.png"))); // NOI18N
        ...
        jLabel1.setText(i18n.tr("<html>In deinem Shellfire Account wurden mehrere VPN gefunden.<br />Bitte wähle den VPN aus, den du benutzen möchtest</html>"));
        ...
        jLabel3.setText(i18n.tr("<html>Hinweis: Die VPN Typen PPTP und L2TP/IPSec müssen nach der Auswahl zunächst auf OpenVPN gewechselt werden, damit sf vpn die Verbindung herstellen kann.</html>"));
        ...
        jSelectVpnPanelLayout.setHorizontalGroup(
                    ...
                    .addGroup(jSelectVpnPanelLayout.createSequentialGroup()
                        .addGroup(jSelectVpnPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jSelectVpnPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(jRememberSelection, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addContainerGap())
        ...
        jSelectVpnPanelLayout.setVerticalGroup(
            jSelectVpnPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jSelectVpnPanelLayout.createSequentialGroup()
                .addContainerGap()
                ...
                .addComponent(jRememberSelection, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jSelectButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jSelectButtonActionPerformed
        try {
            ...
            if (selected == -1) {
                ...
                if (this.askForVpnTypeChangeIfRequired(selectedVpn)) {
  ...
  private void initVpnSelectTable(LinkedList<Vpn> allVpn) {
     ...
     * 
     * @param selectedVpn
     * @return false if cancelled because user decided not to change product type. true if change not needed or change processed properly.
     */
    private boolean askForVpnTypeChangeIfRequired(Vpn selectedVpn) {
        if (selectedVpn.getProductType() != ProductType.OpenVpn) {
            int answer = JOptionPane.showConfirmDialog(null, i18n.tr("Um diesen VPN zu verwenden, muss der Typ zunächst auf OpenVPN geändert werden. \n\nÄnderung jetzt durchführen?\n\nDie Änderung ist völlig kostenfrei und kann jederzeit über das Kundencenter unter www.shellfire.de rückgängig gemacht werden."), i18n.tr("VPN Typ ändern?"), JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            
            if (answer == JOptionPane.YES_OPTION) {
                System.out.println("user decided to change product type");
                this.service.selectVpn(selectedVpn);
                
                boolean result = this.service.setProductTypeToOpenVpn();
