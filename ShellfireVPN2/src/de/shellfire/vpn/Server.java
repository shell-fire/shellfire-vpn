...
import de.shellfire.vpn.gui.Country;
import de.shellfire.vpn.gui.LocatableIcon;
import de.shellfire.vpn.gui.ServerInMapPanel;
import de.shellfire.vpn.gui.VpnI18N;
import de.shellfire.vpn.gui.VpnStar;
...
public class Server implements LocatableIcon {
  ...
  public Server(WsServer wss) {
    ...
    this.iconServerForMap = new ImageIcon(getClass().getResource("/de/shellfire/vpn/gui/resources/sf-server-map-32x32.png")).getImage();
  }
