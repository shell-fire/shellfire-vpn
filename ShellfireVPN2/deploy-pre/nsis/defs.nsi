...
; assert makesnsis.exe is called with /DVERSION=2.3
!define GEN "..\..\deploy_${VERSION}"


!define BIN "${GEN}\bin"
!define BIN-GUI "${GEN}\bin-gui"
!define LIB "${GEN}\lib"
!define LIB-GUI "${GEN}\lib-gui"
!define CONFIG "${GEN}\config"
