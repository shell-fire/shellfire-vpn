...
public class ProcessWrapper extends Thread {
	...
	public static final List<String> failedPassPhraseList = Arrays.asList("TLS Error: Need PEM pass phrase for private key",
			"EVP_DecryptFinal:bad decrypt", "PKCS12_parse:mac verify failure", "Received AUTH_FAILED control message",
			"AUTH: Received control message: AUTH_FAILED", "Auth username is empty");
	public static final List<String> certificateInvalidList = Arrays.asList("error=certificate has expired",
			"error=certificate is not yet valid", "Cannot load certificate file");
	public static final List<String> processRestartingList = Arrays.asList("process restarting", "Connection reset, restarting");
	public static final List<String> processDisconnectedList = Arrays.asList("SIGTERM[hard,] received, process exiting");
	public static final List<String> allTapInUseList = Arrays.asList("All TAP-Win32 adapters on this system are currently in use");
	public static final List<String> notEnoughPrivilegesList = Arrays.asList("Windows route add command failed: returned error code 1",
			"FlushIpNetTable failed on interface");
	public static final List<String> tapDriverTooOld = Arrays
			.asList("This version of OpenVPN requires a TAP-Win32 driver that is at least version");
	public static final List<String> generalError = Arrays.asList("ERROR:", "due to fatal error");
	public static final List<String> tapDriverNotFound = Arrays.asList("There are no TAP-Win32 adapters on this system",
