...
public class VpnSelectDialogController extends AnchorPane implements Initializable {
  ...
  public void initComponents() {
    ...
    this.numAccountVpnLabel.setText(i18n.tr("Multiple VPN are located in your Shellfire account. Please select the VPN you want to use."));
    ...
    this.vpnTypeLabel
        .setText(i18n.tr("Note: VPN types PPTP and L2TP/IPSec have to be switched to OpenVPN before you can connect using sf vpn."));
