...
public class CompositeX509KeyManager implements X509KeyManager {
  ...
  /**
   * Chooses the first non-null client alias returned from the delegate {@link X509TrustManagers}, or {@code null} if there are no matches.
   */
  @Override
  ...
  /**
   * Chooses the first non-null server alias returned from the delegate {@link X509TrustManagers}, or {@code null} if there are no matches.
   */
  @Override
