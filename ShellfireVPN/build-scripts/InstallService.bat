...
set PR_JVMSS=4000
set PR_JVMOPTIONS=
set PR_JVMOPTIONS9=--add-opens=java.base/java.lang=ALL-UNNAMED;--add-opens=java.base/sun.nio.ch=ALL-UNNAMED;--module-path=.\\lib\\javafx\\lib;--add-modules=javafx.swing,javafx.graphics,javafx.fxml,javafx.media,javafx.web;--add-reads=javafx.graphics=ALL-UNNAMED;--add-opens=javafx.controls/com.sun.javafx.charts=ALL-UNNAMED;--add-opens=javafx.graphics/com.sun.javafx.iio=ALL-UNNAMED;--add-opens=javafx.graphics/com.sun.javafx.iio.common=ALL-UNNAMED;--add-opens=javafx.graphics/com.sun.javafx.css=ALL-UNNAMED;--add-opens=javafx.base/com.sun.javafx.runtime=ALL-UNNAMED;--add-exports=java.base/jdk.internal.util=ALL-UNNAMED;--add-exports=java.base/jdk.internal.ref=ALL-UNNAMED;--add-exports=java.base/sun.nio.ch=ALL-UNNAMED;--add-exports=jdk.unsupported/sun.misc=ALL-UNNAMED;--add-exports=jdk.compiler/com.sun.tools.javac.file=ALL-UNNAMED;--add-opens=jdk.compiler/com.sun.tools.javac=ALL-UNNAMED;--add-opens=java.base/java.lang.reflect=ALL-UNNAMED;--add-opens=java.base/java.io=ALL-UNNAMED;--add-opens=java.base/java.util=ALL-UNNAMED;-Dde.shellfire.vpn.runtype=Service
set PR_STARTPARAMS=
